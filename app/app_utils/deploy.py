...
@click.option(
    "--display-name",
    default="vibehuntr-agent",
    help="Display name for the agent engine",
)
@click.option(
    "--description",
    default="ADK RAG agent for document retrieval and Q&A. Includes a data pipeline for ingesting and indexing documents into Vertex AI Search or Vector Search.",
